...
int main()
{
	...
	std::cout << "Enter point 1's Position (x, y, z): ";
	std::cin >> point1;

	std::cout << "Enter point 2's Position (x, y, z): ";
	std::cin >> point2;

	std::cout << "Enter point 3's Position (x, y, z): ";
	std::cin >> point2;

	std::cout << "Enter point 4's Position (x, y, z): ";
	std::cin >> point4;
